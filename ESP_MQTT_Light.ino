...
const char* MQTT_LIGHT_STATE_TOPIC2 = "office/light2/status";
const char* MQTT_LIGHT_COMMAND_TOPIC2 = "office/light2/switch";
...
const PROGMEM uint8_t LED_PIN2 = 5;
...
void publishLight2State() {
  if (m_light2_state) {
    client.publish(MQTT_LIGHT_STATE_TOPIC2, LIGHT2_ON, true);
  } else {
    client.publish(MQTT_LIGHT_STATE_TOPIC2, LIGHT2_OFF, true);
  }
}
